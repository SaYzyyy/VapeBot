...
async def Hello(message: types.Message):
    ...
    global number_pod
    global number_pod_t
    await message.answer_photo(photo = FSInputFile("/Users/sayzyyy/PycharmProjects/VapeBot/images/logo.png"), caption = "ЗДРАВСТВУЙТЕ! 👋\nВы зашли в телеграм-бота вейп-шопа STREET CLOUDS! \n\nЗдесь вы можете ознакомиться с товаром в наличии, "
...
async def buy(callback_query: types.CallbackQuery):
    if os.path.exists("/Users/sayzyyy/PycharmProjects/VapeBot/db/names.txt"):
        with open("/Users/sayzyyy/PycharmProjects/VapeBot/db/names.txt", "r") as f:
