...
#
with open("../handlers/keyboards/parsers/categories.json", "r", encoding="utf-8") as f:
    cats = json.load(f)
    for cat in cats:
        if "ПОД-СИСТЕМЫ" in cat["pathName"]:
            with open("../handlers/keyboards/parsers/new_category2.json", "a", encoding="utf-8") as f:
